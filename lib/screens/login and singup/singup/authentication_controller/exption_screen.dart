...
factory  SignUpWithEmailAndPasswordFailure.code(String code){
  switch(code){
   ...
   case 'invalid email':
  return SignUpWithEmailAndPasswordFailure('Email is valid or badly formatted');
      case ' email already  in use':
  return SignUpWithEmailAndPasswordFailure('An account already exists for that email');
      case 'opration not allwed':
  return SignUpWithEmailAndPasswordFailure('Opration is not allowed please cantact support');
      case 'user disbled':
